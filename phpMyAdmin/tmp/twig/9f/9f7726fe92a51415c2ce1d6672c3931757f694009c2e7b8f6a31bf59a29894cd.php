...
class __TwigTemplate_a6294897f48e6c231f11daeb69280567713517eea61ea68c44d3592f8d99e460 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["cfg_bookmark"]) || array_key_exists("cfg_bookmark", $context))) ? ([0 => "action bookmark", 1 => _gettext("Bookmark")]) : (null)), 7 => [0 => "text failed", 1 => _gettext("Query failed")], 8 => [0 => "text targetdb", 1 => _gettext("Database"), "extraSpan" => (($__internal_compile_3 =                 // line 42
...
";
    ...
    {
        return new Source("", "console/display.twig", "/export/sd05/www/jp/r/e/gmoserver/6/1/sd0079161/freu-de.co.jp/phpMyAdmin/templates/console/display.twig");
    }
}
